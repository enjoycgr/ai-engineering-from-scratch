...
description: Write a complete latency-benchmarking script with warmup, synchronisation, percentiles, and memory tracking (跟踪)
version: 1.0.0
phase: 4
lesson: 15
...
### 1. Warmup
运行 the model `warmup` times without timing. Catches first-forward JIT compilation and cold cache effects.
