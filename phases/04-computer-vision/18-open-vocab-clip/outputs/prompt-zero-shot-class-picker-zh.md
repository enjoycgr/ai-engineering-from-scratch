...
description: Design prompt templates for zero-shot CLIP (对比语言-图像预训练) given a list of classes and a domain
phase: 4
lesson: 18
---
...
- **satellite** — 'satellite imagery of {}', 'aerial photo of {}', 'remote sensing image (图像) of {}'
- **documents** — 'a scanned document of a {}', 'photograph of a {} document', 'OCR (光学字符识别) scan of a {}'
- **industrial** — 'industrial inspection image (图像) of a {}', 'defect image showing {}'
- **memes_social** — add 'a meme of a {}', 'internet image (图像) of a {}'
...
- Never use more than 100 templates per class; diminishing 返回 after about 80.
- Watch class-name casing: CLIP (对比语言-图像预训练) handles "dog" and "Dog" similarly but "DOG" (all caps) worse; normalise to lowercase unless the class name is a proper noun.
